...
class TokenStore:
    ...
    def save_profile(self, profile_name: str, profile_data: Dict) -> None:
        ...
        profile_file = self.store_dir / f"{profile_name}.json"
        profile_file.write_text(json.dumps(encrypted_data, indent=2, default=str))
    ...
    def load_profile(self, profile_name: str) -> Optional[Dict]:
        ...
        try:
            encrypted_data = json.loads(profile_file.read_text())
